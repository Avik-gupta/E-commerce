            ...
            <div className='paymenttypes'>
              <div className='c1'>
                ...
                <img src='https://www.paypalobjects.com/webstatic/en_US/i/buttons/PP_logo_h_100x26.png'
                  alt='paypal' style={{height:'70px',width:'70px'}}
                />
              </div>
              <div className='c1'>
                <input type='radio' name='payment' id='payment1' />
                <img src='https://banner2.cleanpng.com/20180501/lfe/kisspng-google-pay-send-mobile-payment-5ae7ece0662496.4892518115251488964184.jpg'
                  alt='Googlepay' style={{height:'70px',width:'70px'}}
                />
              </div>
              <div className='c1'>
                <input type='radio' name='payment' id='payment1' />
                <img src='https://i.pinimg.com/736x/19/29/17/1929176785bcaf86ef6518447e5f6914.jpg'
                  alt='phonepay' style={{height:'70px',width:'70px'}}
                />
              </div>
            </div>
