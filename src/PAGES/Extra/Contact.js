...
const Contact = () => {
    ...
    return (
        <div className='extrapage'>
            ...
            <h1 style={{textAlign:'center', color:'var(--col1)',marginTop:'15px'}}>Concerns not Addressed?</h1>

            <p style={{border:'1px solid lightgrey',borderRadius:'10px', margin:'10px 20px'}}>It is our priority to positively respond and address any concerns you may have at the earliest. To ensure this, our team is continuously working to provide you the best of support though a few concern/issues that are complex in nature may require additional time to resolve.
...
Level-1: Head of Customer Support: cshead.reliancedigital@ril.com
...
Please allow 24-48 hours for a resolution</p>
